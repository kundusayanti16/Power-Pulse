...
const allowedOrigins = (
  process.env.CLIENT_URL ||
  'https://power-pulse-backend-production.up.railway.app,https://power-pulse-pdpkp23wq-kundusayanti16s-projects.vercel.app,https://power-pulse-iota.vercel.app,http://localhost:5500'
)
.split(',')
